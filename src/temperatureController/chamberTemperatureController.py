...
class ChamberTemperatureController(QThread):
    ...
    def control_heater(self, frame, chamberTemperatures):
        ...
        # OLD LINE
        # self.heater_board.setHeaterPowers(control_left//2, control_left , control_top, control_top, control_right//2, control_right, control_bottom, control_bottom)  #// Set the heater powers ---CH8, CH7, CH6, CH5, CH4, CH3, CH2, CH1
        # NEW
        ...
        self.heater_board.setHeaterPowers(control_left//1.15, control_left//4.71 , control_top//1.15, control_top//4.71, control_right//1.15, control_right//4.71, control_bottom//1.15, control_bottom//4.71)  #// Set the heater powers ---CH8, CH7, CH6, CH5, CH4, CH3, CH2, CH1
